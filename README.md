...
window (5/10/15y sensitivity remains an open robustness gap); refit every 5 days
rather than daily; and VaR is a statistical measure — it excludes liquidity and
model risk.
